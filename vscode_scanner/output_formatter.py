...
class OutputFormatter:
    ...
    def format_output(
        ...
        summary = self._format_summary(
            scan_results, scan_timestamp, scan_duration, cache_stats, failed_extensions
        )
    ...
    def _format_extension(self, result: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if result.get("scan_status") == "success":
            ...
            extension["security"] = {
                ...
                "dependencies_with_vulnerabilities": dependencies.get(
...
def main():
    ...
    test_results = [
        {
            ...
            "security": {"score": 82, "risk_level": "high"},
            "dependencies": {"total_count": 21, "with_vulnerabilities": 0},
            "risk_factors": [
                {
    ...
    output = formatter.format_output(
        test_results, timestamp, duration, cache_stats=cache_stats
    )
